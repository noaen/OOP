...
public class WalkingRouteFormatterTest {
    ...
    public WalkingRouteFormatterTest() {
        ...
        mShortRoute = new Route(new GeoSegment("Trumpeldor Avenue", new GeoPoint(32783098, 35014528),
                new GeoPoint(32787081, 35020735)));
        mShortRoute = mShortRoute.addSegment(
                new GeoSegment("Hagalil", new GeoPoint(32787081, 35020735), new GeoPoint(32795631, 35010296)));
    }

    public void test() {
        String directions = "Turn slight right onto Trumpeldor Avenue and walk for 15 minutes.\n"
