...
public class GeoSegmentTest {
    ...
    public void test() {
        show("equals()");
        show("Self equality", gsNorth.equals(gsNorth));
        show("Equal to copy", gsNorth.equals(new GeoSegment("North", gpZivSquare, gpNorth)));
        show("Totally different objects are not equal.", !gsNorth.equals(gsEast));
        show("Same points, different name are not equal.", !gsEast2.equals(gsWest2));
        show("Same name, different points are not equal.", !gsEast.equals(gsEast2));
        ...
        show("Segment equality should use value equality, not reference equality", gsNorth.equals(gsNorth2));
        show("equals(non-GeoSegment) should be false", !gsNorth2.equals("aString"));
        show("equals(null) should be false", !gsNorth2.equals(null));

        show("hashCode()");
        show(".equals() objects must have the same .hashCode()", gsNorth.hashCode() == gsNorth2.hashCode());

        show("reverse()");
        show("Reversed segment is equal to same segment reversed.", gsEast.reverse().equals(gsEast.reverse()));
        show("Twice reversed segment is equal to initial.", gsEast.reverse().reverse().equals(gsEast));
        show("New reversed item is equal to its reversal.", gsWest.equals(gsWest2.reverse()));
        show("New reversed item is equal to its reversal.", gsWest.reverse().equals(gsWest2));
        show("Segment is not equal to its reversal.", !gsEast.reverse().equals(gsEast));
        show("Segment reversed twice is not equal to its reversal.",
                !gsEast.reverse().reverse().equals(gsEast.reverse()));
        show("Reversed segment reversed is not equal to reversed.", !gsWest.reverse().equals(gsWest2.reverse()));
        ...
        show("North heading (" + nh + ") is not less than zero.", !(nh < 0.0));
        show("North heading (" + nh + ") is not greater or equal to 360.", !(nh >= 360.0));
        show("North heading is expected to be 0 or 359.999", !((nh > tolerance) && (Math.abs(360.0 - nh) > tolerance)));
        show("South heading should be 180", same(gsNorth.reverse().getHeading(), 180.0));
    }
