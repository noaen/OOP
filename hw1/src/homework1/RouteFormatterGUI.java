...
public class RouteFormatterGUI extends JPanel {
    ...
    private WalkingRouteFormatter walkingRoute = null; // Walking directions
                                                       // shown in this
    private DrivingRouteFormatter drivingRoute = null; // Driving directions
                                                       // shown in this
     ...
     * @effects Add new segment to the end of the route shown by this as defined
     *          by Route.addSegment(). In addition, updates the walking
     *          direction and the driving direction of the GUI with the return
     *          value of RouteDirection.computeDirections(this.route,0)
     */
