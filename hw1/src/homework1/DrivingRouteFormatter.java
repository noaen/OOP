...
/**
 * The DrivingDirections class creates a textual description of directions for
 * traversing a route that are suitable for a driver of a vehicle.
 * <p>
 ...
 * the first line, "Hankin" is the name of the first geographic feature of the
 * route, and "0.1 kilometers" is the length of the geographic feature. The
 * length should be reported to tenth-of-a- kilometer precision. Each line
 * should be terminated by a newline and should include no extra spaces other
...
public class DrivingRouteFormatter extends RouteFormatter {
     ...
     *         to traverse this geographical feature.<br>
     ...
     *         tenth-of-a-kilometer precision. The String should be terminated
     *         by a newline and should include no extra spaces other than those
     *         shown above.
     **/
    public String computeLine(GeoFeature geoFeature, double origHeading) {
        ...
        DecimalFormat decFormat = new DecimalFormat("onto " + name + " and go #.# kilometers");
        String str = decFormat.format(distance) + ".\n";
